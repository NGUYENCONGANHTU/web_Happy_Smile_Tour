...
@Component({
  selector: 'app-form-feedback-domestic',
  imports: [
    NzButtonModule,
    NzRateModule,
    NzCardModule,
  ...
  templateUrl: './form-feedback-domestic.component.html',
  styleUrl: './form-feedback-domestic.component.scss',
})
export class FormFeedbackDomesticComponent {
