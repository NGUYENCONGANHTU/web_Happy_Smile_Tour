...
export class AppService {
  ...
  apiUrl14 = environment.API_URL + '/visa-contact';
  ...
  getAlLDataLocationInternational() {
    return this.http.get<LocationResDTO[]>(
      this.apiUrl3 + '/type/INTERNATIONAL'
    );
  }
  ...
  /*============================== TAB DỊCH VỤ ================================*/
  // Nội dung của tab dịch vụ
  getAllDataVisaPrivateTour() {
    return this.http.get<PrivateTourResDTO[]>(this.apiUrl11 + '/type/VISA');
  }
  // Banner của tab dịch vụ
  getAllDataBannerTabService() {
    return this.http.get<PrivateTourResDTO[]>(this.apiUrl11 + '/type/BANNER');
  }
  // Nội dung Visa
  getAllDataContentTabService() {
    return this.http.get<PrivateTourResDTO[]>(this.apiUrl11 + '/type/CONTENT');
  }
  // Tiêu đề Quy trình các bước tiếp nhận hồ sơ trong tab dịch vụ
  getAllDataTitleWorkflowTabService() {
    return this.http.get<PrivateTourResDTO[]>(this.apiUrl11 + '/type/PROCESS');
  }
  getAllDataWorkflowTabService() {
    return this.http.get<PrivateTourResDTO[]>(this.apiUrl11 + '/type/WORKFLOW');
  }

  /*============================== Liên hệ trong page dịch vụ ================================*/
  createDataContactVisa(data: ContactVisaReqDTO) {
    return this.http.post<ContactVisaResDTO>(this.apiUrl12, data);
  }
  getAllDataContactVisa() {
    return this.http.get<ContactVisaResDTO[]>(this.apiUrl12);
  }

  getDataContactByIdVisa(id: number) {
    return this.http.get<ContactVisaResDTO>(`${this.apiUrl12}/${id}`);
  }
  updateDataContactVisa(data: ContactVisaReqDTO, id: number) {
    return this.http.put<ContactVisaResDTO>(`${this.apiUrl12}/${id}`, data);
  }
  deleteDataContactVisa(id: number) {
    return this.http.delete<ContactVisaResDTO>(`${this.apiUrl12}/${id}`);
  }
  ...
  getAllDataBannerContactPage() {
    return this.http.get<ContactPageResDTO[]>(this.apiUrl13 + '/type/BANNER');
  }
  getAllDataAddressContactPage() {
    return this.http.get<ContactPageResDTO[]>(this.apiUrl13 + '/type/ADDRESS');
  }
  getAllDataPhoneContactPage() {
    return this.http.get<ContactPageResDTO[]>(this.apiUrl13 + '/type/PHONE');
  }
  getAllDataEmailContactPage() {
    return this.http.get<ContactPageResDTO[]>(this.apiUrl13 + '/type/EMAIL');
  }
  getAllDataFooterContactPage() {
    return this.http.get<ContactPageResDTO[]>(this.apiUrl13 + '/type/FOOTER');
  }
